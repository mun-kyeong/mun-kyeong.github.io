...
- 왜 많은 오픈 소스 프로젝트와 기업들이 TypeScript를 채택하게 되었을까?
...
- TS를 사용했을 때, jsdoc과 같은 도구를 사용해 문서화하는 것과 어떻게 다를까?
