---
layout: post
title: "[우테코] level-3 / 403 권한 리다이렉트 리렌더링 이슈"
author: kangoll
...
> 요약 <br/>
> 403 권한 에러가 생겼을 때 유저 정보를 초기화 시키고 로그인 페이지로 리다이렉트 시키는 과정에서 겪었던 짧은 트러블슈팅 내용입니다.
...
403 에러가 발생했을 때 서버에서 무효화 처리는 잘 작동했다.<br/> 로컬 스토리지에서 auth 정보도 성공적으로 지웠다.
